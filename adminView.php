    ...
    <ul class="dropdown menu" data-dropdown-menu>
        ...
        <li class="has-submenu">
            ...
            <ul class="submenu menu vertical" data-submenu>
                <li><a id="headerWhite" href="#0">Importar Masivamente</a></li>
                <li><a id="headerWhite" href="#0">Habilitar Masivamente</a></li>
                <li><a id="headerWhite" href="#0">Actualizar Masivamente</a></li>
            </ul>
        </li>
        ...
        <li><a id="headerWhite" href="#0">Reportes</a></li>
    </ul>
    </div>
